...
interface NeuralBackgroundProps {
  ...
  speed?: number
  /**
   * Multiplicador global da opacidade das partículas (0.0 a 1.0).
   * Valores baixos tornam o efeito mais subtil. Default: 1
   */
  opacity?: number
}
...
export default function NeuralBackground({
  ...
  useEffect(() => {
    ...
    // O listener vive na window (e não no container) para que a interação
    // com o rato funcione mesmo com conteúdo sobreposto ao background.
  ...
  }, [color, trailOpacity, particleCount, speed, opacity])
